...
class Step(BaseModel):
    ...
    Step
    """ # noqa: E501
    step_id: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="stepId")
    step_text: Optional[StrictStr] = Field(default=None, alias="stepText")
    __properties: ClassVar[List[str]] = ["stepId", "stepText"]
